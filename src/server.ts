  ...
  async fetch(request: Request, env: unknown, ctx: unknown) {
    try {
      ...
      if (url.pathname.startsWith("/__l5e/")) {
        ...
        if (host.includes("your-project-preview") || !host) {
          host = "id-preview-4be6a3df--ec7aa494-0b27-4dd5-9680-5387d979d3f4.lovable.app";
        }
        host = host.replace(/^https?:\/\//, ""); // strip scheme if any
